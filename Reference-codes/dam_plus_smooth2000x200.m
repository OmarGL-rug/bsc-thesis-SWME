...
(*Export["damBreak-and-smooth_linear_lambda0.1_nu0.1_t5_4000x400.txt",dataset,"CSV"];*)
...
Referencevalues=Table[{xs[i],Hraw[[i,1]],Map[Mean,Uraw][[i]],Map[sMean . #&,Uraw][[i]],Map[\[Kappa]Mean . #&,Uraw][[i]]},{i,1,nx}]//MatrixForm;
dataset=Flatten[Referencevalues];
Export["damBreak-and-smooth_linear_lambda0.1_nu1.0_t5_2000x200.txt",dataset,"CSV"];
...
Referencevalues=Table[{xs[i],Hraw[[i,1]],Map[Mean,Uraw][[i]],Map[sMean . #&,Uraw][[i]],Map[\[Kappa]Mean . #&,Uraw][[i]]},{i,1,nx}]//MatrixForm;
dataset=Flatten[Referencevalues];
Export["damBreak-and-smooth_linear_lambda1.0_nu0.1_t5_2000x200.txt",dataset,"CSV"];
