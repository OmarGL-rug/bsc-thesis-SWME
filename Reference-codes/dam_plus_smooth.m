...
sMean=Table[dy \[Phi]1[ys[i]],{i,1,ny}];
\[Kappa]Mean=Table[dy (\[Phi]2[ys[i-1/2]]+4\[Phi]2[ys[i]]+\[Phi]2[ys[i+1/2]])/6,{i,1,ny}];
...
Referencevalues=Table[{xs[i],Hraw[[i,1]],Map[Mean,Uraw][[i]],Map[sMean . #&,Uraw][[i]],Map[\[Kappa]Mean . #&,Uraw][[i]]},{i,1,nx}]//MatrixForm;
dataset=Flatten[Referencevalues];
Export["damBreak-and-smooth_linear_lambda0.1_nu0.1_t5_200x50.txt",dataset,"CSV"];
...
Referencevalues=Table[{xs[i],Hraw[[i,1]],Map[Mean,Uraw][[i]],Map[sMean . #&,Uraw][[i]],Map[\[Kappa]Mean . #&,Uraw][[i]]},{i,1,nx}]//MatrixForm;
dataset=Flatten[Referencevalues];
Export["damBreak-and-smooth_linear_lambda0.1_nu0.1_t0.5_200x100.txt",dataset,"CSV"];
...
Referencevalues=Table[{xs[i],Hraw[[i,1]],Map[Mean,Uraw][[i]],Map[sMean . #&,Uraw][[i]],Map[\[Kappa]Mean . #&,Uraw][[i]]},{i,1,nx}]//MatrixForm;
dataset=Flatten[Referencevalues];
Export["damBreak-and-smooth_linear_lambda0.1_nu0.1_t5_400x100.txt",dataset,"CSV"];
...
Referencevalues=Table[{xs[i],Hraw[[i,1]],Map[Mean,Uraw][[i]],Map[sMean . #&,Uraw][[i]],Map[\[Kappa]Mean . #&,Uraw][[i]]},{i,1,nx}]//MatrixForm;
dataset=Flatten[Referencevalues];
Export["damBreak-and-smooth_linear_lambda0.1_nu0.1_t5_400x200.txt",dataset,"CSV"];
...
Referencevalues=Table[{xs[i],Hraw[[i,1]],Map[Mean,Uraw][[i]],Map[sMean . #&,Uraw][[i]],Map[\[Kappa]Mean . #&,Uraw][[i]]},{i,1,nx}]//MatrixForm;
dataset=Flatten[Referencevalues];
Export["damBreak-and-smooth_linear_lambda0.1_nu0.1_t5_500x125.txt",dataset,"CSV"];
...
Referencevalues=Table[{xs[i],Hraw[[i,1]],Map[Mean,Uraw][[i]],Map[sMean . #&,Uraw][[i]],Map[\[Kappa]Mean . #&,Uraw][[i]]},{i,1,nx}]//MatrixForm;
dataset=Flatten[Referencevalues];
Export["damBreak-and-smooth_linear_lambda0.1_nu0.1_t5_500x250.txt",dataset,"CSV"];
...
Referencevalues=Table[{xs[i],Hraw[[i,1]],Map[Mean,Uraw][[i]],Map[sMean . #&,Uraw][[i]],Map[\[Kappa]Mean . #&,Uraw][[i]]},{i,1,nx}]//MatrixForm;
dataset=Flatten[Referencevalues];
Export["damBreak-and-smooth_linear_lambda0.1_nu0.1_t5_1000x250.txt",dataset,"CSV"];
...
Referencevalues=Table[{xs[i],Hraw[[i,1]],Map[Mean,Uraw][[i]],Map[sMean . #&,Uraw][[i]],Map[\[Kappa]Mean . #&,Uraw][[i]]},{i,1,nx}]//MatrixForm;
dataset=Flatten[Referencevalues];
Export["damBreak-and-smooth_linear_lambda0.1_nu0.1_t5_1000x500.txt",dataset,"CSV"];
