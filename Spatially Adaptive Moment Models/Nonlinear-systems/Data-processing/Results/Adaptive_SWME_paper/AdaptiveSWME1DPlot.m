...
if(strcmp(plotting,'h'))
    ...
    leg = legend('M=2','M=5','Adaptive: PBC','Adaptive: CIF','Reference','Location','northeast');
    set(leg,'FontSize',12); 
end
...
% export_fig('damBreak-and-smooth_linear_lambda1.0_nu0.1_t5_adaptiveOrder_grouped.pdf', '-pdf','-transparent');