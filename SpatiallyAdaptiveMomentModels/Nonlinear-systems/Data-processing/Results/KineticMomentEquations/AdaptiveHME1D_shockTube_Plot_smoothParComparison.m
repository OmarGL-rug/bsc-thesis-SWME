...
leg = legend('$N_{\mathrm{sub}}=20$','$N_{\mathrm{sub}}=10$','$N_{\mathrm{sub}}=5$','Location','northeast','Interpreter','latex');
set(leg,'FontSize',12); 

% export_name = strcat('Paper\shockTube','_toldown',toldown,'_tolup',tolup,...
%     '_Kn',relaxation_time,'_smoothParComparison.pdf');
% 
