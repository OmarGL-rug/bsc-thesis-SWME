...
if(strcmp(plotting,'rho'))
    ...
    plot1 = plot(x1,rho1,x2,rho2,x3,rho3,x4,rho4,x5,rho5,x6,rho6,x7,rho7,x8,rho8,x9,rho9,x10,rho10)
...
if(strcmp(plotting,'u'))
    % plot1 = plot(x5,rho6,x7,rho7,x8,rho8,x9,rho9)
    plot1 = plot(x1,u1,x2,u2,x3,u3,x4,u4,x5,u5,x6,u6,x7,u7,x8,u8,x9,u9,x10,u10)
%     legend(name1,name2,name3,name4)
...
if(strcmp(plotting,'T'))
    % plot1 = plot(x5,rho6,x7,rho7,x8,rho8,x9,rho9)
    plot1 = plot(x1,T1,x2,T2,x3,T3,x4,T4,x5,T5,x6,T6,x7,T7,x8,T8,x9,T9,x10,T10)
%     legend(name1,name2,name3,name4)
